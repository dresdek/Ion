...
dependencies {
	...
	// implementation("com.github.lightbend.config:1.4.1") // https://github.com/lightbend/config/
	...
	implementation("net.wesjd:anvilgui:1.5.2-SNAPSHOT") // apparently, 1.5.3 causes issues
