...
object MongoManager {
	...
	fun getAccountData(uuid: UUID): AccountData = accountDataCollection.findOneById(uuid.toString()) ?: AccountData(uuid.toString()).also { accountDataCollection.insertOne(it) }
